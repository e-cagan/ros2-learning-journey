...
#include "custom_interfaces/action/detail/move_robot__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const custom_interfaces::action::MoveRobot_Goal & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  custom_interfaces::action::MoveRobot_Goal & ros_message)
{
  // Member: target_distance
  cdr >> ros_message.target_distance;
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = custom_interfaces::action::MoveRobot_Goal;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const custom_interfaces::action::MoveRobot_Goal *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<custom_interfaces::action::MoveRobot_Goal *>(
    untyped_ros_message);
...
{
  return &custom_interfaces::action::typesupport_fastrtps_cpp::_MoveRobot_Goal__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, custom_interfaces, action, MoveRobot_Goal)() {
  return &custom_interfaces::action::typesupport_fastrtps_cpp::_MoveRobot_Goal__handle;
}
...
ROSIDL_TYPESUPPORT_FASTRTPS_CPP_PUBLIC_custom_interfaces
cdr_serialize(
  const custom_interfaces::action::MoveRobot_Result & ros_message,
  eprosima::fastcdr::Cdr & cdr)
{
  // Member: total_time
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  custom_interfaces::action::MoveRobot_Result & ros_message)
{
  // Member: total_time
  cdr >> ros_message.total_time;
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    // We still need to check that the in-memory alignment
    // is the same as the CDR mandated alignment.
    using DataType = custom_interfaces::action::MoveRobot_Result;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const custom_interfaces::action::MoveRobot_Result *>(
    untyped_ros_message);
  return cdr_serialize(*typed_message, cdr);
}
...
{
  auto typed_message =
    static_cast<custom_interfaces::action::MoveRobot_Result *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}
...
{
  return &custom_interfaces::action::typesupport_fastrtps_cpp::_MoveRobot_Result__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, custom_interfaces, action, MoveRobot_Result)() {
  return &custom_interfaces::action::typesupport_fastrtps_cpp::_MoveRobot_Result__handle;
}
...
ROSIDL_TYPESUPPORT_FASTRTPS_CPP_PUBLIC_custom_interfaces
cdr_serialize(
  const custom_interfaces::action::MoveRobot_Feedback & ros_message,
  eprosima::fastcdr::Cdr & cdr)
{
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  custom_interfaces::action::MoveRobot_Feedback & ros_message)
{
  // Member: current_distance
  cdr >> ros_message.current_distance;
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    // We still need to check that the in-memory alignment
    // is the same as the CDR mandated alignment.
    using DataType = custom_interfaces::action::MoveRobot_Feedback;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const custom_interfaces::action::MoveRobot_Feedback *>(
    untyped_ros_message);
  return cdr_serialize(*typed_message, cdr);
}
...
{
  auto typed_message =
    static_cast<custom_interfaces::action::MoveRobot_Feedback *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}
...
{
  return &custom_interfaces::action::typesupport_fastrtps_cpp::_MoveRobot_Feedback__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, custom_interfaces, action, MoveRobot_Feedback)() {
  return &custom_interfaces::action::typesupport_fastrtps_cpp::_MoveRobot_Feedback__handle;
}
...
// functions for custom_interfaces::action::MoveRobot_Goal already declared above
...
ROSIDL_TYPESUPPORT_FASTRTPS_CPP_PUBLIC_custom_interfaces
cdr_serialize(
  const custom_interfaces::action::MoveRobot_SendGoal_Request & ros_message,
  eprosima::fastcdr::Cdr & cdr)
{
  // Member: goal_id
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  custom_interfaces::action::MoveRobot_SendGoal_Request & ros_message)
{
  // Member: goal_id
  ...
  size_t current_alignment)
{
  ...
  // Member: goal
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      bool inner_is_plain;
      size_t inner_size =
        custom_interfaces::action::typesupport_fastrtps_cpp::max_serialized_size_MoveRobot_Goal(
        inner_full_bounded, inner_is_plain, current_alignment);
      last_member_size += inner_size;
      current_alignment += inner_size;
      full_bounded &= inner_full_bounded;
  ...
  if (is_plain) {
    ...
    // We still need to check that the in-memory alignment
    // is the same as the CDR mandated alignment.
    using DataType = custom_interfaces::action::MoveRobot_SendGoal_Request;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const custom_interfaces::action::MoveRobot_SendGoal_Request *>(
    untyped_ros_message);
  return cdr_serialize(*typed_message, cdr);
}
...
{
  auto typed_message =
    static_cast<custom_interfaces::action::MoveRobot_SendGoal_Request *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}
...
{
  return &custom_interfaces::action::typesupport_fastrtps_cpp::_MoveRobot_SendGoal_Request__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, custom_interfaces, action, MoveRobot_SendGoal_Request)() {
  return &custom_interfaces::action::typesupport_fastrtps_cpp::_MoveRobot_SendGoal_Request__handle;
}
...
ROSIDL_TYPESUPPORT_FASTRTPS_CPP_PUBLIC_custom_interfaces
cdr_serialize(
  const custom_interfaces::action::MoveRobot_SendGoal_Response & ros_message,
  eprosima::fastcdr::Cdr & cdr)
{
  // Member: accepted
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  custom_interfaces::action::MoveRobot_SendGoal_Response & ros_message)
{
  // Member: accepted
  {
    uint8_t tmp;
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    // We still need to check that the in-memory alignment
    // is the same as the CDR mandated alignment.
    using DataType = custom_interfaces::action::MoveRobot_SendGoal_Response;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const custom_interfaces::action::MoveRobot_SendGoal_Response *>(
    untyped_ros_message);
  return cdr_serialize(*typed_message, cdr);
}
...
{
  auto typed_message =
    static_cast<custom_interfaces::action::MoveRobot_SendGoal_Response *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}
...
{
  return &custom_interfaces::action::typesupport_fastrtps_cpp::_MoveRobot_SendGoal_Response__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, custom_interfaces, action, MoveRobot_SendGoal_Response)() {
  return &custom_interfaces::action::typesupport_fastrtps_cpp::_MoveRobot_SendGoal_Response__handle;
}
...
{
  return &custom_interfaces::action::typesupport_fastrtps_cpp::_MoveRobot_SendGoal__handle;
}
...
const rosidl_service_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, custom_interfaces, action, MoveRobot_SendGoal)() {
  return &custom_interfaces::action::typesupport_fastrtps_cpp::_MoveRobot_SendGoal__handle;
}
...
ROSIDL_TYPESUPPORT_FASTRTPS_CPP_PUBLIC_custom_interfaces
cdr_serialize(
  const custom_interfaces::action::MoveRobot_GetResult_Request & ros_message,
  eprosima::fastcdr::Cdr & cdr)
{
  // Member: goal_id
  unique_identifier_msgs::msg::typesupport_fastrtps_cpp::cdr_serialize(
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  custom_interfaces::action::MoveRobot_GetResult_Request & ros_message)
{
  // Member: goal_id
  unique_identifier_msgs::msg::typesupport_fastrtps_cpp::cdr_deserialize(
    cdr, ros_message.goal_id);
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    // We still need to check that the in-memory alignment
    // is the same as the CDR mandated alignment.
    using DataType = custom_interfaces::action::MoveRobot_GetResult_Request;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const custom_interfaces::action::MoveRobot_GetResult_Request *>(
    untyped_ros_message);
  return cdr_serialize(*typed_message, cdr);
}
...
{
  auto typed_message =
    static_cast<custom_interfaces::action::MoveRobot_GetResult_Request *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}
...
{
  return &custom_interfaces::action::typesupport_fastrtps_cpp::_MoveRobot_GetResult_Request__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, custom_interfaces, action, MoveRobot_GetResult_Request)() {
  return &custom_interfaces::action::typesupport_fastrtps_cpp::_MoveRobot_GetResult_Request__handle;
}
...
// forward declaration of message dependencies and their conversion functions
// functions for custom_interfaces::action::MoveRobot_Result already declared above
...
ROSIDL_TYPESUPPORT_FASTRTPS_CPP_PUBLIC_custom_interfaces
cdr_serialize(
  const custom_interfaces::action::MoveRobot_GetResult_Response & ros_message,
  eprosima::fastcdr::Cdr & cdr)
{
  // Member: status
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  custom_interfaces::action::MoveRobot_GetResult_Response & ros_message)
{
  // Member: status
  cdr >> ros_message.status;
  ...
  size_t current_alignment)
{
  ...
  // Member: result
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      bool inner_is_plain;
      size_t inner_size =
        custom_interfaces::action::typesupport_fastrtps_cpp::max_serialized_size_MoveRobot_Result(
        inner_full_bounded, inner_is_plain, current_alignment);
      last_member_size += inner_size;
      current_alignment += inner_size;
      full_bounded &= inner_full_bounded;
  ...
  if (is_plain) {
    ...
    // We still need to check that the in-memory alignment
    // is the same as the CDR mandated alignment.
    using DataType = custom_interfaces::action::MoveRobot_GetResult_Response;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const custom_interfaces::action::MoveRobot_GetResult_Response *>(
    untyped_ros_message);
  return cdr_serialize(*typed_message, cdr);
}
...
{
  auto typed_message =
    static_cast<custom_interfaces::action::MoveRobot_GetResult_Response *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}
...
{
  return &custom_interfaces::action::typesupport_fastrtps_cpp::_MoveRobot_GetResult_Response__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, custom_interfaces, action, MoveRobot_GetResult_Response)() {
  return &custom_interfaces::action::typesupport_fastrtps_cpp::_MoveRobot_GetResult_Response__handle;
}
...
{
  return &custom_interfaces::action::typesupport_fastrtps_cpp::_MoveRobot_GetResult__handle;
}
...
const rosidl_service_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, custom_interfaces, action, MoveRobot_GetResult)() {
  return &custom_interfaces::action::typesupport_fastrtps_cpp::_MoveRobot_GetResult__handle;
}
...
// functions for custom_interfaces::action::MoveRobot_Feedback already declared above
...
ROSIDL_TYPESUPPORT_FASTRTPS_CPP_PUBLIC_custom_interfaces
cdr_serialize(
  const custom_interfaces::action::MoveRobot_FeedbackMessage & ros_message,
  eprosima::fastcdr::Cdr & cdr)
{
  // Member: goal_id
  unique_identifier_msgs::msg::typesupport_fastrtps_cpp::cdr_serialize(
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  custom_interfaces::action::MoveRobot_FeedbackMessage & ros_message)
{
  // Member: goal_id
  unique_identifier_msgs::msg::typesupport_fastrtps_cpp::cdr_deserialize(
    cdr, ros_message.goal_id);
  ...
  size_t current_alignment)
{
  ...
  // Member: feedback
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      bool inner_is_plain;
      size_t inner_size =
        custom_interfaces::action::typesupport_fastrtps_cpp::max_serialized_size_MoveRobot_Feedback(
        inner_full_bounded, inner_is_plain, current_alignment);
      last_member_size += inner_size;
      current_alignment += inner_size;
      full_bounded &= inner_full_bounded;
  ...
  if (is_plain) {
    ...
    // We still need to check that the in-memory alignment
    // is the same as the CDR mandated alignment.
    using DataType = custom_interfaces::action::MoveRobot_FeedbackMessage;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const custom_interfaces::action::MoveRobot_FeedbackMessage *>(
    untyped_ros_message);
  return cdr_serialize(*typed_message, cdr);
}
...
{
  auto typed_message =
    static_cast<custom_interfaces::action::MoveRobot_FeedbackMessage *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}
...
{
  return &custom_interfaces::action::typesupport_fastrtps_cpp::_MoveRobot_FeedbackMessage__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, custom_interfaces, action, MoveRobot_FeedbackMessage)() {
  return &custom_interfaces::action::typesupport_fastrtps_cpp::_MoveRobot_FeedbackMessage__handle;
}
